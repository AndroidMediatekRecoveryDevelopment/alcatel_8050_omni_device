...
BOARD_MKBOOTIMG_ARGS  := --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --tags_offset 0x0e000000 --board vA2X-0
TARGET_PREBUILT_KERNEL := device/alcatel/8050/kernel
...
# RECOVERY
TARGET_RECOVERY_FSTAB := device/alcatel/8050/twrp.fstab


# PARTTIONS
# We need the partitions size in decimal
# Use cat proc/partitions via adb, then block size * 1024
# This is the partitions of alcatel ROM, system size is bigger than Android One ROM
